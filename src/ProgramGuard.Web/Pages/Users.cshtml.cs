...
namespace ProgramGuard.Web.Pages
{
    ...
    public class UsersModel : BasePageModel
    {
        ...
        public async Task<IActionResult> OnPutToggleDisabledAsync(string key)
        {
            try
            {
                ...
                HttpResponseMessage response = await client.PutAsync($"/User/{key}/toggleDisabled",null);
        ...
        public async Task<IActionResult> OnPutToggleAdminAsync(string key)
        {
            try
            {
                ...
                HttpResponseMessage response = await client.PutAsync($"/User/{key}/toggleAdmin", null);
